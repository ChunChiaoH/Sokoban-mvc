...
# Web API Messages
WEB_GAME_NOT_INITIALIZED = 'Game not initialized. Call /api/init first.'
WEB_MISSING_DIRECTION = 'Missing direction in JSON. Expected: {"direction": "UP|DOWN|LEFT|RIGHT"}'
WEB_INVALID_DIRECTION = 'Invalid direction: {}. Expected: UP, DOWN, LEFT, RIGHT'
WEB_ROOM_COMPLETED = 'Room completed! Well done!'
WEB_MOVE_BLOCKED = 'Move blocked. Try a different direction.'
WEB_MOVED_SUCCESS = 'Moved {}'
WEB_GAME_INITIALIZED = 'Game initialized!'
